...
public class PerformanceCycleRepository
    : IPerformanceCycleRepository
{
    ...
    public PerformanceCycle? GetById(
        Guid id)
    {
        return context.PerformanceCycles
            .FirstOrDefault(
    ...
    public void Update(
        PerformanceCycle cycle)
    {
        context.PerformanceCycles.Update(
            cycle);
    }
    ...
    public void Delete(
        PerformanceCycle cycle)
    {
        context.PerformanceCycles.Remove(
            cycle);
    }

    public bool HasOverlappingCycle(
        DateOnly startDate,
        DateOnly endDate,
        Guid? excludeId = null)
    {
