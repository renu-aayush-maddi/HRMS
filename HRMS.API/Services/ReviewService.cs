...
public class ReviewService : IReviewService
{
    ...
    public List<ReviewResponseDto> GetEmployeeReviews(Guid employeeId)
    {
    ...
    public List<ReviewResponseDto> GetMyReviews(Guid employeeUserId)
    {
        var employee = reviewRepository.GetEmployeeByUserId(employeeUserId);
        ...
        return reviewRepository.GetEmployeeReviews(employee.Id)
            .Select(r => new ReviewResponseDto
            {
                Id = r.Id,
                EmployeeName = r.Employee!.FirstName + " " + r.Employee.LastName,
