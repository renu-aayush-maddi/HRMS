    ...
    : IPerformanceCycleService
{
        ...
        Guid id)
    {
        ...
        {
            throw new BusinessException(
                "Cycle contains reviews");
        }

        if(repository.HasRecommendations(id))
        {
            throw new BusinessException(
                "Cycle contains recommendations");
        }
    ...
    public List<PerformanceCycleResponseDto>
        GetAllCycles()
    {
        return repository
            .GetAll()
            .Select(x =>
                new PerformanceCycleResponseDto
                {
                    Id = x.Id,
    ...
    public PerformanceCycleResponseDto
        GetCycleById(
            Guid id)
    {
        var cycle =
